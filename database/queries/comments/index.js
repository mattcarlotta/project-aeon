module.exports = {
  ...
  findComment:
    "SELECT c.id, c.uid, c.qid, c.rid, c.body, c.date, $2=ANY(c.upvoters) as upvoted, $2=ANY(c.downvoters) as downvoted, c.votes, u.username FROM comments c JOIN users u ON c.uid = u.id WHERE c.id=$1",
  findComments:
  ...
  updateComment:
    "UPDATE comments SET body=$3 WHERE id=$1 AND uid=$2 RETURNING id",
  upvoteComment:
