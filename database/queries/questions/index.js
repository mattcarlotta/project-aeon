module.exports = {
  ...
  updateQuestion:
    "UPDATE questions SET body=$3, description=$4, tags=$5, title=$6, uniquetitle=$7, date=$8 WHERE id=$1 AND uid=$2;SELECT id, body, tags, title, uniquetitle FROM questions where id=$1 AND uid=$2",
